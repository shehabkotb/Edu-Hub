...
class SignUp extends Component {
  ...
  handleChange = (event) => {
    ...
    switch (name) {
      case 'studentid':
        errors.studentid =
          value.length !== 6 ? 'Student Id must be at 6 characters' : ''
        break
      case 'firstname':
        errors.firstname =
          value.length < 3 ? 'firstname is at least 3 characters long' : ''
        break
      case 'lastname':
        errors.lastname =
          value.length < 3 ? 'lastname is at least 3 characters long' : ''
        break
      case 'email':
