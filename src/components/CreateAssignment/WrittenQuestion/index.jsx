...
import { KeyWords, QuestionContent, FormItemQuestionContent , Hrline, CheckLabel, GroupButton,   FormButton1,  FormButton2 } from './style'
class WrittenQuestion extends React.Component {
  ...
  onToggle =()=>{
    this.setState(prevstate => ({ showInputValue: !prevstate.showInputValue}));
  }
                    ...
                    <KeyWords >
                      ...
                      {showInputValue && ( <Input
                        ...
                        />)}
                         ...
                         {tags.length>0 ?tags.map((word) => <Tag   onClose={e => {
                            e.preventDefault();
                            this.handleClose(word);
                        }}
                        closable key={word} color="#2db7f5">{word}</Tag>) :<Tag color="gray">none</Tag>}
