...
import { ReceivedQuestionHeader, ReceivedQuestionTitle, ReceivedQuestionBody , QuestionIcon } from './style'
...
const ReceivedWritten = (props) => {
    const { Points, QuestionTitle, Answer, TextMatch, AutoGraded, QuestionType, KeyWords } = props.questionData;
    const id = props.id +1  ; 
        ...
        <ReceivedQuestionHeader>
            ...
            <ReceivedQuestionBody>
                ...
                <div>
                 ...
                 &nbsp;
                 TextMatch : {TextMatch ? <CheckCircleOutlined style={{ fontSize: '16px', color: '#108ee9', margin: '5px' }} /> : <CloseCircleOutlined style={{ fontSize: '16px', color: 'gray', margin: '5px' }} />}
                 &nbsp;
                 ...
                 KeyWords : {KeyWords.length>0 ? KeyWords.map((word , index) => <b key={index} >{word} </b> ) : <span>none</span>}
